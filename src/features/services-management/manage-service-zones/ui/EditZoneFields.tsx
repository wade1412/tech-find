...
import type {
  ...
  ZoneFormErrors,
  ZoneFormState,
} from "../model/manage-zones.types";

interface EditZoneFieldsProps {
  disabled: boolean;
  errors: ZoneFormErrors | null;
  formState: ZoneFormState;
  onFieldChange: (key: ZoneFieldKey, value: string) => void;
}

type ZoneTextField = "name" | "slug";
    ...
    <fieldset disabled={disabled} className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        {TEXT_FIELDS.map(({ key, label }) => {
          ...
          const helpId = key === "slug" ? "zone-slug-help" : undefined;
          ...
          return (
            <div key={key}>
              ...
              {key === "slug" && (
                <p id="zone-slug-help" className={inputHintStyle}>
