  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        className="w-full rounded-xl border border-zinc-200 bg-zinc-50/50 py-2 pr-3.5 pl-9 text-sm text-zinc-900 outline-none transition-[background-color,border-color,box-shadow] focus:border-main-500 focus:bg-white focus:ring-2 focus:ring-main-500/20 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-main-500 dark:focus:bg-zinc-950"
      />
