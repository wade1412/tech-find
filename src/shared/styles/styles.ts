...
// ------- Login and Auth page Styles -------
export const loginContainerStyle =
  "flex min-h-screen flex-col bg-zinc-50 text-zinc-950 dark:bg-zinc-950 dark:text-zinc-50";
export const loginFormStyle = `${formStyle} w-full max-w-sm rounded-2xl border border-zinc-200/80 bg-white p-6 shadow-lg shadow-zinc-200/30 dark:border-zinc-800 dark:bg-zinc-900/50 dark:shadow-none`;
export const loginLabelStyle =
  "flex flex-col text-sm font-medium text-zinc-700 dark:text-zinc-300 gap-1.5";
export const loginErrorStyle =
...
// ------- Management Styles -------
// Layout: Container, Grid/List, Heading
